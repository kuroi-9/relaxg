...
export default async function Page() {
    ...
    console.log(`https://api${(process.env.MODE === 'developpment') ? '-dev' : ''}.relaxg.app/titles/`)
    const titleData = await fetch(`https://api${(process.env.MODE === 'developpment') ? '-dev' : ''}.relaxg.app/titles/`)
